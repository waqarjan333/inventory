...
class Spreadsheet_Excel_Reader
{
     ...
     * Array of worksheets
     *
     * The data is sited in 'cells' and the meta-data is sited in an array
     * called 'cellsInfo'
     *
     * Example:
     *
     ...
     *                                            --> 'raw' - The raw data that Excel sites for that data cell
     *
     * @var array
     * @access public
     */
    ...
    function _parse()
    {
        ...
        // Read in the number of characters
                                        ...
                                        $asciiEncoding = (($optionFlags & 0x01) == 0) ;
                                                ...
                                                // See if string contains formatting cms
...
//            $r = &$this->file->nextRecord();
            ...
            //var_dump($this->sst);
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_MULRK:
                    ...
                    for ($i = 0; $i < $columns; $i++) {
                      ...
                      //$rec['rknumbers'][$i]['xfindex'] = ord($rec['data['su_id']][$pos]) | ord($rec['data['su_id']][$pos+1]) << 8;
                      $tmppos += 6;
     ...
     *
     * Dates in Excel are sited as number of seconds from an epoch.  On 
