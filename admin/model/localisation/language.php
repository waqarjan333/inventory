...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		...
		// cms
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "cms_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $cms) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "cms_description SET cms_id = '" . (int)$cms['cms_id'] . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($cms['title']) . "', description = '" . $this->db->escape($cms['description']) . "'");
		}		
		...
		foreach ($query->rows as $product) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description SET deal_id = '" . (int)$product['deal_id'] . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($product['name']) . "', meta_description= '" . $this->db->escape($product['meta_description']) . "', description = '" . $this->db->escape($product['description']) . "'");
		}
		...
		foreach ($query->rows as $product_option) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_description SET product_option_id = '" . (int)$product_option['product_option_id'] . "', language_id = '" . (int)$language_id . "', deal_id = '" . (int)$product_option['deal_id'] . "', name = '" . $this->db->escape($product_option['name']) . "'");
		}
		...
		foreach ($query->rows as $product_option_value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value_description SET product_option_value_id = '" . (int)$product_option_value['product_option_value_id'] . "', language_id = '" . (int)$language_id . "', deal_id = '" . (int)$product_option_value['deal_id'] . "', name = '" . $this->db->escape($product_option_value['name']) . "'");
		}
		...
		// site
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "site_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $site) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "site_description SET site_id = '" . (int)$site['site_id'] . "', language_id = '" . (int)$language_id . "', description = '" . $this->db->escape($site['description']) . "'");
		}
	...
	public function deleteLanguage($language_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "site_description WHERE language_id = '" . (int)$language_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "cms_description WHERE language_id = '" . (int)$language_id . "'");
