...
class ControllerSettingSite extends Controller {
	private $error = array();  
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'index.php?route=setting/site/update&site_id=' . $site_id);
    	} 
    	$this->getForm();
  	}
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'index.php?route=setting/site/update&site_id=' . $this->request->get['site_id']);
		}
  	...
  	public function delete() {
		...
		if (isset($this->request->get['site_id']) && $this->validateDelete()) {
			$this->model_setting_site->deletesite($this->request->get['site_id']);
	...
	public function getForm() { 
		...
		$this->data['entry_siteusers_group'] = $this->language->get('entry_siteusers_group');
		$this->data['entry_siteusers_price'] = $this->language->get('entry_siteusers_price');
		$this->data['entry_siteusers_approval'] = $this->language->get('entry_siteusers_approval');
		...
		$this->data['button_delete_site'] = $this->language->get('button_delete_site');
		...
		if (isset($this->error['catalog_limit'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=setting/site',
		...
		if (isset($this->request->get['site_id'])) {
			$this->data['delete'] = HTTPS_SERVER . 'index.php?route=setting/site/delete&site_id=' . $this->request->get['site_id'];
		} else {
			$this->data['delete'] = '';
		}
		...
		if (!isset($this->request->get['site_id'])) {
			...
			$this->data['cancel'] = HTTPS_SERVER . 'index.php?route=setting/site/update&site_id=' . $this->request->get['site_id'];
		}
		
		if (!isset($this->request->get['site_id'])) {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=setting/site/insert';
		} else {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=setting/site/update&site_id=' . $this->request->get['site_id'];
		}
		...
		foreach ($results as $result) {
			$this->data['sites'][] = array(
				...
				'name'     => $result['name'],
				'href'     => HTTPS_SERVER . 'index.php?route=setting/site/update&site_id=' . $result['site_id']
			); 
		}
		
		if (isset($this->request->get['site_id'])) {
			$this->data['site_id'] = $this->request->get['site_id'];
		} else {
			$this->data['site_id'] = 0;
		}
	
		if (isset($this->request->get['site_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      		$site_info = $this->model_setting_site->getsite($this->request->get['site_id']);
    	}
		
		if (isset($this->request->post['name'])) {
			$this->data['name'] = $this->request->post['name'];
		} elseif (isset($site_info)) {
			$this->data['name'] = $site_info['name'];
		} else {
			$this->data['name'] = '';
		}
		...
		if (isset($this->request->post['title'])) {
			...
			$this->data['title'] = $site_info['title'];
		} else {
			$this->data['title'] = '';
		}
		...
		if (isset($this->request->post['meta_description'])) {
			...
			$this->data['meta_description'] = $site_info['meta_description'];		
		} else {
		...
		if (isset($this->request->post['template'])) {
			...
			$this->data['template'] = $site_info['template'];			
		} else {
			$this->data['template'] = '';
		}
		...
		if (isset($this->request->post['site_description'])) {
			$this->data['site_description'] = $this->request->post['site_description'];
		} elseif (isset($site_info)) {
			$this->data['site_description'] = $this->model_setting_site->getsiteDescriptions($this->request->get['site_id']);
		} else {
		...
		if (isset($this->request->post['country_id'])) {
			...
			$this->data['country_id'] = $site_info['country_id'];		
		} else {
		...
		if (isset($this->request->post['zone_id'])) {
			...
			$this->data['zone_id'] = $site_info['zone_id'];				
		} else {
			$this->data['zone_id'] = '';
		}
		...
		if (isset($this->request->post['language'])) {
			...
			$this->data['language_code'] = $site_info['language'];			
		} else {
		...
		if (isset($this->request->post['currency'])) {
			...
			$this->data['currency_code'] = $site_info['currency'];			
		} else {
		...
		if (isset($this->request->post['tax'])) {
			...
			$this->data['tax'] = $site_info['tax'];			
		} else {
			$this->data['tax'] = '';
		}

		$this->load->model('sale/siteusers_group');
		
		$this->data['siteusers_groups'] = $this->model_sale_siteusers_group->getCustomerGroups();
		
		if (isset($this->request->post['siteusers_group_id'])) {
			$this->data['siteusers_group_id'] = $this->request->post['siteusers_group_id'];
		} elseif (isset($site_info)) {
			$this->data['siteusers_group_id'] = $site_info['siteusers_group_id'];			
		} else {
			$this->data['siteusers_group_id'] = '';
		}
		
		if (isset($this->request->post['siteusers_price'])) {
			$this->data['siteusers_price'] = $this->request->post['siteusers_price'];
		} elseif (isset($site_info)) {
			$this->data['siteusers_price'] = $site_info['siteusers_price'];			
		} else {
			$this->data['siteusers_price'] = '';
		}
		
		if (isset($this->request->post['siteusers_approval'])) {
			$this->data['siteusers_approval'] = $this->request->post['siteusers_approval'];
		} elseif (isset($site_info)) {
			$this->data['siteusers_approval'] = $site_info['siteusers_approval'];			
		} else {
			$this->data['siteusers_approval'] = '';
		}
		
		if (isset($this->request->post['guest_checkout'])) {
			$this->data['guest_checkout'] = $this->request->post['guest_checkout'];
		} elseif (isset($site_info)) {
			$this->data['guest_checkout'] = $site_info['guest_checkout'];		
		} else {
		...
		if (isset($this->request->post['account_id'])) {
			...
			$this->data['account_id'] = $site_info['account_id'];			
		} else {
		...
		if (isset($this->request->post['checkout_id'])) {
			...
			$this->data['checkout_id'] = $site_info['checkout_id'];		
		} else {
		...
		if (isset($this->request->post['stock_check'])) {
			...
			$this->data['stock_check'] = $site_info['stock_check'];		
		} else {
		...
		if (isset($this->request->post['stock_checkout'])) {
			...
			$this->data['stock_checkout'] = $site_info['stock_checkout'];		
		} else {
		...
		if (isset($this->request->post['stock_subtract'])) {
			...
			$this->data['stock_subtract'] = $site_info['stock_subtract'];		
		} else {
		...
		if (isset($this->request->post['catalog_limit'])) {
			...
			$this->data['catalog_limit'] = $site_info['catalog_limit'];	
		} else {
		...
		if (isset($this->request->post['cart_weight'])) {
			...
			$this->data['cart_weight'] = $site_info['cart_weight'];	
		} else {
		...
		if (isset($this->request->post['order_status_id'])) {
			...
			$this->data['order_status_id'] = $site_info['order_status_id'];		
		} else {
		...
		if (isset($this->request->post['logo'])) {
			...
			$this->data['logo'] = $site_info['logo'];			
		} else {
			$this->data['logo'] = '';
		}

		if (isset($site_info['logo']) && file_exists(DIR_IMAGE . $site_info['logo'])) {
			$this->data['preview_logo'] = HTTPS_IMAGE . $site_info['logo'];		
		} else {
		...
		if (isset($this->request->post['icon'])) {
			...
			$this->data['icon'] = $site_info['icon'];			
		} else {
			$this->data['icon'] = '';
		}
		
		if (isset($site_info['icon']) && file_exists(DIR_IMAGE . $site_info['icon'])) {
			$this->data['preview_icon'] = HTTPS_IMAGE . $site_info['icon'];
		} else {
		...
		if (isset($this->request->post['image_thumb_width'])) {
			...
			$this->data['image_thumb_width'] = $site_info['image_thumb_width'];			
		} else {
		...
		if (isset($this->request->post['image_thumb_height'])) {
			...
			$this->data['image_thumb_height'] = $site_info['image_thumb_height'];				
		} else {
		...
		if (isset($this->request->post['image_popup_width'])) {
			...
			$this->data['image_popup_width'] = $site_info['image_popup_width'];			
		} else {
		...
		if (isset($this->request->post['image_popup_height'])) {
			...
			$this->data['image_popup_height'] = $site_info['image_popup_height'];			
		} else {
		...
		if (isset($this->request->post['image_category_width'])) {
			...
			$this->data['image_category_width'] = $site_info['image_category_width'];			
		} else {
		...
		if (isset($this->request->post['image_category_height'])) {
			...
			$this->data['image_category_height'] = $site_info['image_category_height'];			
		} else {
		...
		if (isset($this->request->post['image_product_width'])) {
			...
			$this->data['image_product_width'] = $site_info['image_product_width'];		
		} else {
		...
		if (isset($this->request->post['image_product_height'])) {
			...
			$this->data['image_product_height'] = $site_info['image_product_height'];		
		} else {
		...
		if (isset($this->request->post['image_additional_width'])) {
			...
			$this->data['image_additional_width'] = $site_info['image_additional_width'];			
		} else {
		...
		if (isset($this->request->post['image_additional_height'])) {
			...
			$this->data['image_additional_height'] = $site_info['image_additional_height'];				
		} else {
		...
		if (isset($this->request->post['image_related_width'])) {
			...
			$this->data['image_related_width'] = $site_info['image_related_width'];		
		} else {
		...
		if (isset($this->request->post['image_related_height'])) {
			...
			$this->data['image_related_height'] = $site_info['image_related_height'];			
		} else {
		...
		if (isset($this->request->post['image_cart_width'])) {
			...
			$this->data['image_cart_width'] = $site_info['image_cart_width'];			
		} else {
		...
		if (isset($this->request->post['image_cart_height'])) {
			...
			$this->data['image_cart_height'] = $site_info['image_cart_height'];			
		} else {
		...
		if (isset($this->request->post['ssl'])) {
			...
			$this->data['ssl'] = $site_info['ssl'];
		} else {
			$this->data['ssl'] = '';
		}
		
		$this->template = 'setting/site.tpl';
		$this->children = array(
			'common/header',	
			'common/footer',
			'common/leftcol'	
	...
	private function validateForm() {
		...
		if (!$this->error) {
			...
			if (!isset($this->error['warning'])) {
				$this->error['warning'] = $this->language->get('error_required_data['su_id']);
			}
			return FALSE;
		}
	}
	...
	private function validateDelete() {
		...
		$site_total = $this->model_sale_order->getTotalOrdersBysiteId($this->request->get['site_id']);
