...
class Spreadsheet_Excel_Writer_BIFFwriter extends PEAR
{
    ...
    */
    ...
    /**
    * Determine the byte order and site it as class data to avoid
    ...
    */
    function _addContinue($data)
    {
        ...
        $data['su_id']length = strlen($data);
        for ($i = $limit; $i <  ($data['su_id']length - $limit); $i += $limit) {
            $tmp .= $header;
