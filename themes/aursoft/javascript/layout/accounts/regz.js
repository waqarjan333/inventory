    ...
    listeners: {
        beforeclose: function () {
            ...
            account_store.clearFilter();
                 Ext.getCmp("toolTipId").setVisible(false);
        }
        ,
        afterrender: function () {
            var width_table=0;
                  if(enableCustomRegions==1){
                Ext.getCmp("_custreg_group_name_").setVisible(true);
            } else {
                Ext.getCmp("_custreg_group_name_").setVisible(false);
            } 
              var customer_id=Ext.getCmp("reg_customers_combo").getValue();
               if(customer_id ==null)
               {
                Ext.getCmp("toolTipId").setVisible(false);
                Ext.getCmp("reg_date").setVisible(false);
                Ext.getCmp("reg_Todate").setVisible(false);
                //Ext.getCmp("RegInfo").setVisible(false);
               }
               if(enable_regTooltip==0)
               {
                Ext.getCmp("toolTipId").setVisible(false);
                Ext.getCmp("reg_date").setVisible(false);
                Ext.getCmp("reg_Todate").setVisible(false);
                Ext.getCmp("RegInfo").setVisible(true);
                // Ext.get("fieldset-1213").setStyle('border','none');
               }
        },
        ...
        show: function () {
            ...
            register_obj.lessBalance = function (me, balance) {
                Ext.Msg.show({
                    ...
                    fn: function (btn, text) {
                        if (btn == 'yes') {
                            payInProcess = false;
                            register_obj.payfunc(me, true, '0');
                        }
                    }
                });
            }
               register_obj.populateRegTooltip=function(invtip) {
                var customer_account = customer_store_active_reg.getById(Ext.getCmp("reg_customers_combo").getValue());
               
                // var data=''; 
                var from_date='';
                var reg_Fromdate= Ext.getCmp("reg_date").getValue();
                var reg_Todate= Ext.getCmp("reg_Todate").getValue();
                console.log(reg_Fromdate);
                if(reg_Fromdate==null)
                {
                    from_date='';
                }
                else{
                    from_date= Ext.Date.format(Ext.getCmp("reg_date").getValue(), 'Y-m-d'+ ' 0:0:0');
                }
                
                var to_date= Ext.Date.format(Ext.getCmp("reg_Todate").getValue(), 'Y-m-d')+ ' ' + Ext.Date.format(new Date(), 'H:i:s');
                
                
                if (customer_account) {
                   var account_id = customer_account.get("account_id");
                } 
               
                 if(Ext.getCmp("register_Type").getValue()=='0')
                 {
                        Ext.Ajax.request({
                url: action_urls.get_customer_regRecord,
                method: 'GET',
                params: {
                    acc_id: account_id,
                    from_date:from_date,
               ...
               var data = Ext.JSON.decode(response.responseText);
                       if(data.customerReg[0].sale_return>0)
                    {
                        widths:400
                    }
                    else{
                   ...
                   // if(data.customerReg[0].balance!=0)
                   // {
                           invtip.update('<div class="popover-content"><table class="registerTable"><tbody><tr style="display:'+data.customerReg[0].show+'"><td  border="1">Opening Balance</td>'+
                    '<td >:</td><td border="1">'+data.customerReg[0].openbal+'</td></tr>'+
                    '<tr><td border="1">Sale</td><td >:</td><td border="1">'+data.customerReg[0].sale+'</td>'+
                    '<td style="padding-left: 20px;display:'+data.customerReg[0].show_return+'" border="1">Sale Return</td><td style="display:'+data.customerReg[0].show_return+'">:</td><td style="display:'+data.customerReg[0].show_return+'" border="1">'+data.customerReg[0].sale_return+'</td></tr>'+
                    '</tr><tr><td border="1">Purchase</td><td>:</td><td border="1">'+data.customerReg[0].purchase+'</td><td style="padding-left: 20px;display:'+data.customerReg[0].show_return+'" border="1">Return Cost</td><td style="display:'+data.customerReg[0].show_return+'">:</td><td border="1" style="display:'+data.customerReg[0].show_return+'">'+data.customerReg[0].returncost+'</td></tr>'+
                    '<tr style="display:'+data.customerReg[0].show_regdisc+'"><td border="1" >Register Discount</td><td>:</td><td>'+data.customerReg[0].reg_disc+'</td></tr>'+ 
                    '<tr><td border="1">Profit/Revenue</td><td>:</td>'+
                    '<td border="1">'+data.customerReg[0].profit+'</td><td style="padding-left: 20px;display:'+data.customerReg[0].show_return+'">Return Revenue</td><td style="display:'+data.customerReg[0].show_return+'">:</td><td border="1" style="display:'+data.customerReg[0].show_return+'">'+data.customerReg[0].returnProfit+'</td></tr><tr><td>Paid</td><td>:</td><td>'+data.customerReg[0].paid+'</td>'+
                    
                    '</tr><tr style="display:'+data.customerReg[0].show_charge+'"><td border="1">Register Charge</td><td>:</td><td border="1">'+data.customerReg[0].charge+'</td>'+
                    '</tr>'+
                    '<tr><td style="font-weight:bold;font-size:14px">Balance</td><td style="font-weight:bold;font-size:14px">:</td><td style="font-weight:bold;font-size:14px">'+data.customerReg[0].balance+'</td></tr></tbody></table></div>');
                   //} 
                   // else{
                   //  invtip.update('<div class="popover-content"><table><tbody><tr><td colspan="2" ><h4>NO Record Found</h4><td></tr></tbody></table></div>')
                   // }   
                ...
                failure: function () {
                         ...
                         var vendor_account = vendor_store_active.getById(Ext.getCmp("reg_vendors_combo").getValue())
                           if (vendor_account) {
                   var account_id = vendor_account.get("vendor_acc_id");
                }

                            Ext.Ajax.request({
                url: action_urls.get_vendor_regRecord,
                method: 'GET',
                params: {
                    acc_id: account_id,
                    from_date:from_date,
               ...
               var data = Ext.JSON.decode(response.responseText);
                         ...
                         invtip.update('<div class="popover-content"><table class="registerTable"><tbody><tr ><td  border="1">Opening Balance</td>'+
                    '<td >:</td><td border="1">'+data.vendorReg[0].openbal+'</td></tr>'+
                    '<tr><td border="1">Purchase</td><td >:</td><td border="1">'+data.vendorReg[0].purchase+'</td>'+
                    '<td style="padding-left: 20px;" border="1">Purchase Return</td><td >:</td><td  border="1">'+data.vendorReg[0].purchase_Ret+'</td></tr>'+
                    '<td  border="1">Amount Paid</td><td >:</td><td  border="1">'+data.vendorReg[0].vendorAmount+'</td></tr>'+
                     '<tr><td style="font-weight:bold;font-size:14px">Balance</td><td style="font-weight:bold;font-size:14px">:</td><td style="font-weight:bold;font-size:14px">'+data.vendorReg[0].balance+'</td></tr></tbody></table></div>');
            ...
            register_obj.RegisterTP = function()
            {   
                var title='';
                    if(Ext.getCmp("register_Type").getValue()=='0')
                    {
                        ...
                        title: '<h3 class="popover-title">Customer Register Info</h3>',                        
                        target : toolTipId,                                                                      
                        anchor: 'left',
                        cls:'callout',
                        trackMouse: true,
                        ...
                        return tip.width = widthTip;;
                            ...
                            beforeshow: function updateTipBody(invtip ) {
                                register_obj.populateRegTooltip(invtip)
                            },
                        ...
                        Ext.defer(function(){
                        Ext.create('Ext.tip.ToolTip', {        
                        title: '<h3 class="popover-title">Vendor Register Info</h3>',                        
                        target : toolTipId,                                                                      
                        anchor: 'left',
                        cls:'callout',
                        trackMouse: true,
                    ...
                    // console.log(Ext.getCmp("register_Type").getValue())
                        ...
                        show: function () {
                            ...
                            if (Ext.getCmp("register_Type").getValue() == "0" || (Ext.getCmp("register_Type").getValue() == "4" && loan_store_active.getById(Ext.getCmp("reg_loans_combo").getValue()).get("loan_type") == "14")) {
                                if (Ext.getCmp("register_Type").getValue() == "4") {
                                    ...
                                    account_id = customer_store_active_reg.getById(Ext.getCmp("reg_customers_combo").getValue()).get("account_id");
                                }
                                type_id = "1";
                            ...
                            if (type_id == "1") {
                                ...
                                Ext.getCmp("payment__methods_combo").setVisible(true);
                                Ext.getCmp("payment__mode_combo").setVisible(true);
                                Ext.getCmp("register_sale_rep_assign").setVisible(true);
                                Ext.getCmp("paid_total").setFieldLabel("Pay");
                            ...
                            
                            {
                                ...
                                handler: function () {
                                    ...
                                    if (me.isValid()) {
                                        ...
                                        var loan_id = me.findField("loans_id").getValue();
                                        if (loan_id == 0) {
                                            if ((payment_type == 1) && (pay_type == 1 || pay_type == 2))
                                            {
                                                if (parseFloat(pay_total) > register_obj.balance) {
                                                    Ext.Msg.show({
                                                        ...
                                                        fn: function (btn, text) {
                                                            if (btn == 'yes') {
                                                                register_obj.payfunc(me, false, '0');
                                            ...
                                            else if(payment_type == 3)
                                            {
                                                  if (parseFloat(pay_total) > register_obj.balance) {
                                                    Ext.Msg.show({
                                                        title: 'Payment exceeded',
                                                        msg: 'You are giving Discount more then customer balance, are you sure you want to proceed?',
                                                        buttons: Ext.Msg.YESNO,
                                                        icon: Ext.Msg.QUESTION,
                                                        fn: function (btn, text) {
                                                            if (btn == 'yes') {
            ...
            reports_obj = {
                ...
                printme: function () {
                    ...
                    for (var i = 0; i < _grid.length; i++) {
                        ...
                        tbody_html += "<tr><td  align='center' width='14%'>" + _grid[i].date + "</td>";
                        tbody_html += "<td width='8%'>" + _grid[i].number + "</td>";
                        tbody_html += "<td width='17%' align='center'>" + _grid[i].payee + "</td>";
                        tbody_html += "<td width='10%' align='center'>" + _grid[i].account + "</td>";
                        tbody_html += "<td width='20%' align='center' style='align:justify;font-size:12px'>" + _grid[i].detail + "</td>";
                        tbody_html += "<td width='13%' align='center'>" + _inc + "</td>";
                        tbody_html += "<td width='8%' align='center'>" + _dec + "</td>";
                        tbody_html += "<td width='10%' align='center'>" + Ext.util.Format.number(_grid[i].balance, "0.00") + "</td></tr>";
                    }
                    // print_iframe.$(".register_customer").html(Ext.getCmp("reg_customers_combo").getRawValue())
                    
                      var Register_type = Ext.getCmp("register_Type").getValue();
                        // console.log(Register_type)
                        // console.log(Ext.getCmp("reg_loans_combo").getRawValue())
                        if(Register_type=='0'){
                      ...
                      print_iframe.$("#name").html(Ext.getCmp("reg_expense_combo").getRawValue());
                        ...
                        // console.log(Ext.getCmp("reg_loans_combo").getValue())
                                ...
                                items: [
                                    {
                                        xtype: 'combo',
                                        fieldLabel: "Regions",
                                        id: '_custreg_group_name_',
                                        name: 'custreg_group_name',
                                        allowBlank: false,
                                        valueField: 'id',
                                        width:100,
                                        maxWidth:100,
                                        ...
                                        listeners: {
                                            change: function (f, obj) {
                                              Ext.Ajax.request({
                                                ...
                                                Ext.getCmp("reg_customers_combo").store.loadData(data.customers);
                                                },
                                                failure: function () {
                                                }
                                            });  
                                    ...
                                    },
                                    {
                                        ...
                                        store: customer_store_active_reg,
                                        queryMode: 'local',
                                        listeners: {
                                            change: function (f, obj) {
                                                ...
                                                if (record) {
                                                    if(enable_regTooltip==1)
                                                    {

                                                     Ext.getCmp("toolTipId").setVisible(true);
                                                      Ext.getCmp("RegInfo").setVisible(true);
                                                    }
                                 ...
                                 items: [
                                   {
                                            ...
                                            listeners: {
                                                click: function (obj) {
                                                    ...
                                                    Ext.getCmp("reg_date").setVisible(true);
                                                    Ext.getCmp("reg_Todate").setVisible(true);
                                                    register_obj.RegisterTP()
                                                    // console.log('Working...')
                                                }
                                            }
                                        },
