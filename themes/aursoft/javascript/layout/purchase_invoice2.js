_po = {
    ...
    listeners: {
        ...
        afterrender: function () {
              ...
              Ext.getCmp('purchase_invoice_grid').columns[3].setVisible(true);
              Ext.getCmp('receive_invoice_grid').columns[2].setVisible(true);
            } else {
                Ext.getCmp('purchase_invoice_grid').columns[3].setVisible(false);
                 Ext.getCmp('receive_invoice_grid').columns[2].setVisible(false);
            }
            if(enableUom==0)
            {
        ...
        show: function () {
            ...
            OBJ_Action.printme = function () {
                if (parseInt(Ext.getCmp('po_hidden_id').getValue()) !== 0) {
                    try {
                        ...
                        print_iframe.$(".dates").css({'position':'absolute','top':'2%','left':'50%'});
                        ...
                        print_iframe.$(".dates_pos").css({'position':'absolute','top':'-25px','right':'50%','width':'100%'});
            ...
            if (purchase_invoice_return_mode === 1) {
                ...
                Ext.getCmp('purchase_invoice_grid').columns[6].setText(labels_json.purchaseinvoicepanel.col_deduction);
                ...
                Ext.getCmp('purchase_invoice_grid').columns[6].setText(labels_json.purchaseinvoicepanel.col_discount);
    ...
    items: [
        {
            ...
            items: [{
                    ...
                    items: [{xtype: "gridpanel",
                            ...
                            columnLines: true,
                            columns: [
                                {header: labels_json.purchaseinvoicepanel.text_order_no, dataIndex: "inv_no", width: 40},
                                {header: labels_json.purchaseinvoicepanel.text_vendor, dataIndex: "vendor_name", width: 140},
                                {header: labels_json.purchaseinvoicepanel.text_date, dataIndex: "order_date", width: 80}
