        ...
        <div class="jquery_tab">
              <div class="content_block">
                     <h2 class="jquery_tab_title"><?php echo $heading_title; ?></h2>
                      <div class="topbuttons"><a onclick="window.open('<?php echo $invoice; ?>');" class="button"><span><?php echo $button_invoice; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div> 
                        <div style="display: inline-block; width: 100%;">
                          ...
                          <div id="tab_order" class="vtabs_page">
                            <table class="form">
                              ...
                              <?php if ($siteusers) { ?>
                              <tr>
                                <td><?php echo $entry_siteusers; ?></td>
                                <td><a href="<?php echo $siteusers; ?>"><?php echo $firstname; ?> <?php echo $lastname; ?></a></td>
                              </tr>
                              <?php } else { ?>
                              <tr>
                                <td><?php echo $entry_siteusers; ?></td>
                              ...
                              <?php } ?>
                              <?php if ($siteusers_group) { ?>
                              <tr>
                                <td><?php echo $entry_siteusers_group; ?></td>
                                <td><?php echo $siteusers_group; ?></td>
                              </tr>
                              <?php } ?>
                              <tr>
                              ...
                              <tr>
                                <td><?php echo $entry_site_url; ?></td>
                                <td><a onclick="window.open('<?php echo $site_url; ?>');"><u><?php echo $site_url; ?></u></a></td>
                              </tr>
                              <tr>
                            ...
                            <table id="product" class="list">
                              <thead>
                                <tr>
                                  ...
                                  <td class="right" width="1" colspan="2"><?php echo $column_total; ?></td>
                                </tr>
                              </thead>
...
function history() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#tab_history .form').before('<div class="attention"><img src="themes/admin/images/loading_1.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
