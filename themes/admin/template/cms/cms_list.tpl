              ...
              <div class="content_block">
                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="list">
                    ...
                    <tbody>
                      <?php if ($cmsp) { ?>
                      <?php foreach ($cmsp as $cms) { ?>
                      <tr>
                        <td style="text-align: center;"><?php if ($cms['selected']) { ?>
                          <input type="checkbox" name="selected[]" value="<?php echo $cms['cms_id']; ?>" checked="checked" />
                          <?php } else { ?>
                          <input type="checkbox" name="selected[]" value="<?php echo $cms['cms_id']; ?>" />
                          <?php } ?></td>
                        <td class="left"><?php echo $cms['title']; ?></td>
                        <td class="left"><?php echo $cms['type']; ?></td>
                        <td class="right"><?php echo $cms['sort_order']; ?></td>
                        <td class="right"><?php foreach ($cms['action'] as $action) { ?>
