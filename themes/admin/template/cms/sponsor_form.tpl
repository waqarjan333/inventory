 ...
 <div id="bg_wrapper"> 
   <div id="main"> 
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          <td><span class="required">*</span> Sponsor name</td>
          <td><input name="name" value="<?php echo $sponsor['sponsor_description']; ?>" />
            <?php if ($error_name) { ?>
        ...
        <tr>
          ...
          <td><input name="sponsor_url" value="<?php echo  $sponsor['sponsor_url']; ?>" />
            <?php if ($error_name) { ?>
        ...
        <tr>
          ...
          <td>
          	...
          	<input type="hidden" name="sponsor_image" value="<?php //echo $sponsor_image; ?>" id="image" />
        ...
        <tr>
            ...
            <td>
            	<select name="sponsor_type">
                	<option value="1" <?php if($sponsor['sponsor_type'] == 1) echo "selected"; ?> >Website</option>
                    <option value="2" <?php if($sponsor['sponsor_type'] == 2) echo "selected"; ?> >Document</option>
                    <option value="3" <?php if($sponsor['sponsor_type'] == 3) echo "selected"; ?> >Internal URL</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            	<input type="text" name="internal_url" value="<?=$sponsor['internal_url']?>" />
            </td>
        </tr>
        <tr>
        	<td>
            ...
            <td>
            	<select name="display">
                	<option value="1" <?php if($sponsor['display'] == 1) echo "selected"; ?> >Big</option>
                    <option value="2" <?php if($sponsor['display'] == 2) echo "selected"; ?> >Small</option>
                </select>
            </td>
        </tr>
        <tr>
          ...
          <td>
          	<select name="sponsor_status">
          		<option <?php if($sponsor['sponsor_status'] == 1) echo "selected" ?> value ="1">Enable</option>
          		<option <?php if($sponsor['sponsor_status'] == 0) echo "selected" ?> value ="0">Disable</option>	
          	</select>
          </td>
        </tr>
      </table>
