...
<script type="text/javascript" src="../themes/admin/javascript/jquery/jstree/jquery.tree.min.js"></script>
<script type="text/javascript" src="../themes/admin/javascript/jquery/ajaxupload.js"></script>
...
<body>
<div id="container">
  <div id="menu"><!--<a id="create" class="button" style="background-image: url('../themes/admin/image/filemanager/folder.png');" disabled="disabled"><?php echo $button_folder; ?></a>--><a id="upload" class="button" style="background-image: url('../themes/admin/image/filemanager/upload.png');"><?php echo $button_upload; ?></a><a id="delete" class="button" style="background-image: url('../themes/admin/image/filemanager/edit-delete.png');"><?php echo $button_delete; ?></a><a id="move" class="button" style="background-image: url('../themes/admin/image/filemanager/edit-cut.png');"><?php echo $button_move; ?></a><a id="copy" class="button" style="background-image: url('../themes/admin/image/filemanager/edit-copy.png');"><?php echo $button_copy; ?></a><a id="rename" class="button" style="background-image: url('../themes/admin/image/filemanager/edit-rename.png');"><?php echo $button_rename; ?></a><a id="refresh" class="button" style="background-image: url('../themes/admin/image/filemanager/refresh.png');"><?php echo $button_refresh; ?></a></div>
...
$(document).ready(function () { 
	...
	$('#column_right a').live('dblclick', function () {
		<?php if ($fckeditor) { ?>
		window.opener.CKEDITOR.tools.callFunction(1, '<?php echo str_replace("/admin/","/", $directory); ?>' + $(this).attr('file'));
	...
	new AjaxUpload('#upload', {
		...
		onSubmit: function(file, extension) {
			$('#upload').append('<img src="themes/admin/images/loading.gif" id="loading" style="padding-left: 5px;" />');
		},
