...
(function()
{
	...
	function createTemplateItem( editor, template, imagesPath )
	{
		...
		if( template.image && imagesPath )
			html += '<td class="cke_tpl_preview_img"><img src="../../../../../../../../admin/view/javascript/ckeditor/_source/plugins/templates/dialogs/' + CKEDITOR.getUrl( imagesPath + template.image ) + '"></td>';
