...
(function()
{
	...
	// sites dialog related data from skin definitions. e.g. margin sizes.
	var skinData = {};
...
//		}
	...
	// Grab the margin data from skin definition and site it away.
...
CKEDITOR.tools.extend( CKEDITOR.editor.prototype,
	/** @lends CKEDITOR.editor.prototype */
	{
		...
		openDialog : function( dialogName )
		{
			...
			{
				var sitedDialogs = this._.sitedDialogs ||
					( this._.sitedDialogs = {} );

				var dialog = sitedDialogs[ dialogName ] ||
					( sitedDialogs[ dialogName ] = new CKEDITOR.dialog( this, dialogName ) );
