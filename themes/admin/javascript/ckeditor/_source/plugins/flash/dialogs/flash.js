		...
		return {
			...
			onShow : function()
			{
				...
				if ( fakeImage && fakeImage.getAttribute( '_cke_real_element_type' ) && fakeImage.getAttribute( '_cke_real_element_type' ) == 'flash' )
				{
					...
					var realElement = editor.resiteRealElement( fakeImage ),
									...
									[
										{
											...
											onLoad : function()
											{
												...
												updatePreview = function( src ){
													...
													dialog.preview.setHtml( '<embed height="100%" width="100%" src="../../../../../../../../admin/view/javascript/ckeditor/_source/plugins/flash/dialogs/'
