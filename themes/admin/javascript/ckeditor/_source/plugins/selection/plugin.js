			...
			editor.on( 'contentDom', function()
				{
					...
					if ( CKEDITOR.env.ie )
					{
						...
						// possible to resite the selection before click
						// events get executed.
						doc.on( 'focusin', function()
							{
								// If we have saved a range, resite it at this
								// point.
								if ( savedRange )
								{
		...
		getRanges :
			CKEDITOR.env.ie ?
				( function()
				{
					...
					// of an IE range.
					var getBoundarycms = function( range, start )
					{
					...
					return function()
					{
						...
						if ( type == CKEDITOR.SELECTION_TEXT )
						{
							...
							var boundaryInfo = getBoundarycms( nativeRange, true );
							range.setStart( new CKEDITOR.dom.node( boundaryInfo.container ), boundaryInfo.offset );

							boundaryInfo = getBoundarycms( nativeRange );
