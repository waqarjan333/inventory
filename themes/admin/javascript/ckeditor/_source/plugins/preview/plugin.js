		...
		exec : function( editor )
		{
			...
			else
			{
				var bodyHtml = '<body ',
					...
					baseTag = ( editor.config.baseHref.length > 0 ) ? '<base href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/preview/' + editor.config.baseHref + '" _cktemp="true"></base>' : '';
				...
				sHTML =
					...
					'<link type="text/css" rel="stylesheet" href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/preview/' +
					[].concat( editor.config.contentsCss ).join( '"><link type="text/css" rel="stylesheet" href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/preview/' ) +
					'">' +
					'</head>' + bodyHtml +
					editor.getData() +
					'</body></html>';
