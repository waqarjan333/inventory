			...
			if ( this.forceIFrame || this.css.length )
			{
				...
				doc.$.write(
					...
					'<html dir="' + dir + '" class="' + className + '_container" lang="' + langCode + '">' +
						...
						// available. (#3031)
						'<link type="text/css" rel=stylesheet href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/panel/' + this.css.join( '"><link type="text/css" rel="stylesheet" href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/panel/' ) + '">' +
					'<\/html>' );
				doc.$.close();
