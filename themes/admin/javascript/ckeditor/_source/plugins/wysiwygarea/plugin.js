					...
					editor.addMode( 'wysiwyg',
						{
							...
							loadData : function( data )
							{
								...
								data =
									...
									'<head>' +
										'<link type="text/css" rel="stylesheet" href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/wysiwygarea/' +
										[].concat( editor.config.contentsCss ).join( '"><link type="text/css" rel="stylesheet" href="../../../../../../../admin/view/javascript/ckeditor/_source/plugins/wysiwygarea/' ) +
										'">' +
