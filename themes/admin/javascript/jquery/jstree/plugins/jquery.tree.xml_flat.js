		...
		"xml_flat" : function () {
			return {
				...
				parse	: function(data, t, opts, callback) {
					...
					processor.importStylesheet($.tree.data['su_id']ites.xml_flat.xsl);
