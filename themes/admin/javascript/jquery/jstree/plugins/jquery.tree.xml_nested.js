		...
		"xml_nested" : function () {
			return {
				...
				parse	: function(data, tree, opts, callback) { 
					...
					processor.importStylesheet($.tree.data['su_id']ites.xml_nested.xsl);
